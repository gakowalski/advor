...
void setbandwidthval(HWND hDlg,uint64_t bwrate,int checkbox,int editbox,int combo,int defval)
{	int i=0,j=0;
	if(!bwrate)
...
{	if(uMsg==WM_INITDIALOG)
	{	if(LangGetLanguage())
		...
		setbandwidthval(hDlg,tmpOptions->BandwidthRate,10400,10100,10300,5*1024*1024);
		setbandwidthval(hDlg,tmpOptions->BandwidthBurst,10401,10101,10301,10*1024*1024);
		setbandwidthval(hDlg,tmpOptions->MaxAdvertisedBandwidth,10402,10102,10302,1024*1024*1024);
		setbandwidthval(hDlg,tmpOptions->RelayBandwidthRate,10403,10103,10303,0);
		setbandwidthval(hDlg,tmpOptions->RelayBandwidthBurst,10404,10104,10304,0);
		setbandwidthval(hDlg,tmpOptions->PerConnBWRate,10413,10113,10306,0);
		setbandwidthval(hDlg,tmpOptions->PerConnBWBurst,10414,10114,10307,0);
		setbandwidthval(hDlg,tmpOptions->AccountingMax,10405,10105,10305,0);
