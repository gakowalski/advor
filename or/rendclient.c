...
static void
rend_service_authorization_free(rend_service_authorization_t *auth,char *c,int n)
{
  _tor_free_(auth,c,n);
}
...
static void
rend_service_authorization_strmap_item_free(void *service_auth,char *c,int n)
{
