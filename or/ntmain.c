...
{	HMODULE library = 0;
	...
	else if(!(service_fns.CreateServiceA_fn = GetProcAddress(library,"CreateServiceA")))
	...
	else if(!(service_fns.OpenSCManagerA_fn = GetProcAddress(library,"OpenSCManagerA")))
		log_err(LD_BUG,get_lang_str(LANG_LOG_NTMAIN_ADVAPI32_WITHOUT_API),"OpenSCManagerA");
	else if(!(service_fns.OpenServiceA_fn = GetProcAddress(library,"OpenServiceA")))
	...
	else if(!(service_fns.RegisterServiceCtrlHandlerA_fn = GetProcAddress(library,"RegisterServiceCtrlHandlerA")))
