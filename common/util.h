...
/* Memory management */
#ifdef DEBUG_MALLOC
void *_tor_malloc(size_t size DMALLOC_PARAMS,char *,int) ATTR_MALLOC;
void *_tor_malloc_zero(size_t size DMALLOC_PARAMS,char *,int) ATTR_MALLOC;
void *_tor_malloc_roundup(size_t *size DMALLOC_PARAMS,char *,int) ATTR_MALLOC;
void *_tor_realloc(void *ptr, size_t size DMALLOC_PARAMS,char *,int);
