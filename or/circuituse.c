...
#define SET_CUTOFF(target, msec) do {                       \
	...
	if(!circ_times.timeout_ms)	circ_times.timeout_ms = get_options()->CircuitBuildTimeout * 1000;
	if(!circ_times.close_ms)	circ_times.close_ms = get_options()->CircuitBuildTimeout * 1000;
